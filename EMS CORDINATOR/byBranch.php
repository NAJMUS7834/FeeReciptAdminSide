...
$result = mysqli_query($conn, "select * from studentdb where studentdb.branch='$branch'") or die("Query fail :" .mysqli_error());
?>
<h2>RECIPTS STATUS BY BRANCH</h2>
<table ><tr><th>USN</th> <th>SEM</th> <th>Branch</th> <th>section</th> <th>RECIVED</th>  <th>UPLOAD</th> <th>fname</th></tr>
