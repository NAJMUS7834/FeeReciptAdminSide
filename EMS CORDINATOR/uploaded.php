...
$result = mysqli_query($conn, "select * from studentdb where studentdb.branch='$branch' AND studentdb.uploaded='$uploaded'") or die("Query fail :" .mysqli_error());
?>
<h2>RECIPTS NOT UPLOADED TO PORTAL</h2>
<table ><tr><th>USN</th>  <th>SEM</th> <th>Branch</th> <th>section</th> <th>RECIVED</th> <th>UPLOAD</th> <th>faculty</th> </tr>
...
<?php if ($result->num_rows > 0) {
  ...
  $row["branch"]. "</td><td>" . $row["sec"]. "</td> <td>" . $row["recived"]."</td><td>". $row["uploaded"]."</td><td>".$row["fname"]."</tr>" ;
