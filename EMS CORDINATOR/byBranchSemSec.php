...
$result = mysqli_query($conn, "select * from studentdb where studentdb.sem='$sem' AND studentdb.branch='$branch' AND studentdb.sec='$sec'") or die("Query fail :" .mysqli_error());
?>
<h2>RECIPTS STATUS BY BRANCH SEM & SECTION</h2>
